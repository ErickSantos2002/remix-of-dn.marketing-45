...
interface NumbersCasesSection05MaioProps {
  onOpenModal: () => void;
}
...
export function NumbersCasesSection05Maio({ onOpenModal }: NumbersCasesSection05MaioProps) {
  return (
      ...
      <div className="section-container max-w-[1080px]">
        <div className="text-center mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.1] mb-4">
            Resultados que empresários como você{" "}
            <span className="text-accent">já tiveram com IA.</span>
            <br />
        ...
        <div className="text-center mt-16">
          ...
          <Button
            onClick={onOpenModal}
            size="lg"
            className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-base md:text-lg px-12 py-7 h-auto rounded-full shadow-[0_8px_30px_hsl(var(--primary)/0.4)] tracking-wider"
          >
            GARANTIR MINHA VAGA (MEMBROS R1)
          </Button>
        </div>
      </div>
    </section>
