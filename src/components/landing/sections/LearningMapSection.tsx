import { Calendar, Radio, Target, DollarSign, Check, X as XIcon } from "lucide-react";

const eventInfo = [
  { icon: Calendar, label: "24 e 25 de Fevereiro", sub: "Evento de 2 dias" },
  { icon: Radio, label: "100% ao vivo", sub: "Sem replay disponível" },
  { icon: Target, label: "Vagas limitadas", sub: "Turma reduzida" },
  { icon: DollarSign, label: "R$47", sub: "Investimento único" },
];
      ...
      <div className="section-container max-w-[1080px]">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.1] mb-4">
            O mapa completo para colocar
            <br />
            <span className="text-accent">IA no estratégico da sua empresa.</span>
          </h2>
          <p className="text-sm md:text-base text-muted-foreground max-w-[600px] mx-auto leading-relaxed">
            Não é aula de ferramenta. É um evento para você sair com um plano de
            ação pronto, sabendo exatamente o que implementar primeiro.
          </p>
        </div>
