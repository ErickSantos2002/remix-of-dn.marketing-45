...
export const ConvidadoModal = ({ isOpen, onClose }: ConvidadoModalProps) => {
  ...
  const CHECKOUT_URL = "https://pay.hotmart.com/S104360061O?checkoutMode=10&bid=1770773860261";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (lead) {
        ...
        await registerConversion({
          leadId: lead.id,
          tipo: "aula 24 e 25 fev",
          pageSlug: "modal-evento-24-25fev",
        ...
        sendMetaConversion({
          ...
          custom_data: {
            lead_type: 'Lançamento 24 e 25Fev',
            source: pageSlug
          }
        });
    ...
    // Inicia countdown para redirect ao checkout
    setCountdown(3);
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-black/80 backdrop-blur-sm" onClick={countdown === null ? onClose : undefined} />
        ...
        {countdown !== null ? (
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground mb-6">
              Você será redirecionado para a página de pagamento em
            </p>
          ...
          <>
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-foreground mb-2 flex items-center justify-center gap-2">
                <Target className="w-6 h-6 text-primary" /> Garanta sua chance de escalar seus resultados
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isLoading ? "Processando..." : "FAZER MINHA APLICAÇÃO"}
              </Button>
