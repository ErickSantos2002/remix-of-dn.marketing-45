...
interface ConvidadoModalGratuito05MaioProps {
  isOpen: boolean;
  onClose: () => void;
}
...
export const ConvidadoModalGratuito05Maio = ({ isOpen, onClose }: ConvidadoModalGratuito05MaioProps) => {
    ...
    try {
      ...
      if (lead) {
        ...
        await registerConversion({
          leadId: lead.id,
          tipo: "imersão r1 05mai",
          pageSlug: "modal-imersao-r1-05mai",
          ...
          <>
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-foreground mb-2 flex items-center justify-center gap-2">
                <Target className="w-6 h-6 text-destructive" /> Confirme sua vaga na imersão R1
              </h2>
              <p className="text-muted-foreground text-sm">
                Acesso restrito a membros do <strong className="text-foreground">Grupo R1</strong>. Preencha seus dados para garantir sua participação.
              </p>
            </div>
