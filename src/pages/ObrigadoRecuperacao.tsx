...
const ObrigadoRecuperacao = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // UPDATE direto pelo email - lead já foi criado anteriormente
      ...
      const { error } = await supabase.functions.invoke("send-to-pingback-paid", {
        body: {
          ...
          customFields: [
            ...
            { fieldName: "source", fieldValue: "recuperacao-dados-imersao" }
          ]
        },
      });
...
export default ObrigadoRecuperacao;
